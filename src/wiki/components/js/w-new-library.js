...
import Form from './w-form';
import Input from './w-input';
import Select from './w-select';
import Button from './w-button';
import Result from './w-result';

import '../css/w-new-library.less';

let b = block('w-new-library');
    ...
    render() {
        if (this.state.loaded) {
            ...
            return <div {...b(this)}>
                ...
                <Form mix="w-new-library__form" flash={this.state.flash} onSubmit={this.handleSubmit.bind(this)}>
                    <Form.Fields>
